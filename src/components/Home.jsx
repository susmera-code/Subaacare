        ...
        <div>
            ...
            <div className="container">
                ...
                <div className="card mb-3 text-start">
                    <h5 className="fw-semibold mt-3 text-blue">A Personal Turning Point</h5>
                    <p>
                    ...
                    <h5 className="fw-semibold mt-3 text-blue">A Gap That Needed Attention</h5>
                    <p>During this journey, it became evident that:</p>
                    <ul>
                        <li>
